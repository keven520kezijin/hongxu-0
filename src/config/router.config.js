...
export const asyncRouterMap = [

  {
    ...
    children: [
      ...
      {
        path: 'registrationResidence',
        name: 'registrationResidence',
        component: () => import('@/views/registrationResidence/index'),
        meta: { title: '居民登记', keepAlive: true, icon: 'form' }
      },
      {
        path: 'rueryResidents',
        name: 'rueryResidents',
        component: () => import('@/views/rueryResidents/index'),
        meta: { title: '查询居民', keepAlive: true, icon: 'form' }
      },
      {
        path: 'rueryHouse',
        name: 'rueryHouse',
        component: () => import('@/views/rueryHouse/index'),
